...
import { BarChart3, BookOpen, ClipboardCheck, Users, UserPlus, GraduationCap } from 'lucide-react'
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <Card title="Create Student" subtitle="Add a new student record" action={<UserPlus size={18} className="text-gold-700" />}>
            <form onSubmit={createStudent} className="grid gap-3">
              ...
              <button type="submit" className="btn btn-primary mt-1">Create Student</button>
            </form>
          </Card>
